    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById("inputPersonInfo").innerHTML =
                ...
                "            <label for=\"avi\">Update Your Profile Picture!<img class=\"userImage\" src=\"";
                if(profilePic === null) {
                    // use default image if not already input
                    document.getElementById("inputPersonInfo").innerHTML += "Images/uploadIcon.png";
                }
                else {
                    document.getElementById("inputPersonInfo").innerHTML += profilePic;
                }
                document.getElementById("inputPersonInfo").innerHTML += "\"></label>\n" +
                    ...
                    "    <form class='EditPersonPage' name='updateSong' onsubmit='setSong()'>\n" +
...
function setSong() {
    ...
    songMap.set('All You Need Is Love - The Beatles', 'Music/All%20You%20Need%20Is%Love.mp3');
    songMap.set( 'Dog - Remo Drive', 'Music/Dog.mp3');
    songMap.set('Dog Days Are Over - Florence + The Machine', 'Music/Dog%20%Days%20Are%20Over.mp3');
    songMap.set( 'Dynamite - BTS', 'Music/Dynamite.mp3');
    songMap.set( 'Loving Is Easy - Rex Orange County', 'Music/Loving%20Is%20Easy.mp3');
    songMap.set( "Me & You Together Song - The 1975", 'Music/Me%20&%20You%20Together%20Song.mp3');
    songMap.set( 'Mooo! - Doja Cat','Music/Mooo!.mp3');
    songMap.set('Watermelon Sugar - Harry Styles', 'Music/Watermelon%20Sugar.mp3');
    songMap.set( 'What\'s New Pussycat - Tom Jones', 'Music/What\'s%20New%20Pussycat.mp3');
